...
<head><title>Fadded Socials</title><!-- [Meta] -->
    ...
    <link rel="icon" href="{{url('')}}/assets/assets2/images/favicon.svg" type="image/x-icon"><!-- [Page specific CSS] start -->
    <link rel="stylesheet" href="{{url('')}}/assets/assets2/css/plugins/datepicker-bs5.min.css"><!-- [Page specific CSS] end -->
    <!-- [Font] Family -->
            ...
            <div class="card pc-user-card">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <div class="flex-shrink-0"><img src="{{url('')}}/assets/assets2/images/user/avatar-1.jpg" alt="user-image"
        ...
        <div class="ms-auto">
            <ul class="list-unstyled">
                ...
                <li class="dropdown pc-h-item header-user-profile"><a
                        ...
                        aria-expanded="false"><img src="{{url('')}}/assets/assets2/images/user/avatar-2.jpg" alt="user-image"
                                                   class="user-avtar"></a>
                        ...
                        <div class="dropdown-body">
                            <div class="profile-notification-scroll position-relative"
                                ...
                                <div class="d-flex mb-1">
                                    <div class="flex-shrink-0"><img src="{{url('')}}/assets/assets2/images/user/avatar-2.jpg"
                                ...
                                <p class="text-span">Team</p><a href="##"
                                    ...
                                    <div class="user-group"><img src="{{url('')}}/assets/assets2/images/user/avatar-1.jpg"
                                ...
                                <div class="card border-0 shadow-none drp-upgrade-card mb-0"
                                     style="background-image: url({{url('')}}/assets/assets2/images/layout/img-profile-card.jpg)">
                                    <div class="card-body">
                                        <div class="user-group"><img src="{{url('')}}/assets/assets2/images/user/avatar-1.jpg"
                                                                     alt="user-image" class="avtar"> <img
                                                src="{{url('')}}/assets/assets2/images/user/avatar-2.jpg" alt="user-image" class="avtar">
                                            <img src="{{url('')}}/assets/assets2/images/user/avatar-3.jpg" alt="user-image"
                                                 class="avtar"> <img src="{{url('')}}/assets/assets2/images/user/avatar-4.jpg"
                                                                     alt="user-image" class="avtar"> <img
                                                src="{{url('')}}/assets/assets2/images/user/avatar-5.jpg" alt="user-image" class="avtar">
        ...
        <div class="card mb-3">
            <div class="card-body">
                ...
                <p class="text-muted">Able Pro is completely renowed with high aesthetics User Interface.</p><img
                    src="{{url('')}}/assets/assets2/images/layout/img-announcement-1.png" alt="img" class="img-fluid mb-3">
                <div class="row">
                    <div class="col-12">
            ...
            <div class="card-body">
                ...
                <p class="text-muted">Download Able Pro exclusive on themeforest with best price.</p><a
                    href="https://1.envato.market/zNkqj6" target="_blank"><img
                        src="{{url('')}}/assets/assets2/images/layout/img-announcement-2.png" alt="img" class="img-fluid"></a></div>
        </div>
        ...
        <div class="card mb-3">
            <div class="card-body">
                ...
                <p class="text-muted">Do you know Able Pro is one of the featured dashboard template selected by
                    Themeforest team.?</p><img src="{{url('')}}/assets/assets2/images/layout/img-announcement-3.png" alt="img"
                                               class="img-fluid"></div>
        </div>
        <div class="card mb-3">
            <div class="card-body">
                ...
                <p class="text-muted">Get the lifetime free updates once you purchase the Able Pro.</p><img
                    src="{{url('')}}/assets/assets2/images/layout/img-announcement-4.png" alt="img" class="img-fluid"></div>
        </div>
    </div>
            ...
            <ul class="list-group list-group-flush">
                ...
                <li class="list-group-item"><h6 class="mb-1">Theme layout</h6>
                    ...
                    <div class="theme-main-layout d-flex align-center gap-1 w-100"><a href="#"
                                ...
                                src="{{url('')}}/assets/assets2/images/customizer/caption-on.svg" alt="img" class="img-fluid"> </a><a
                            href="#" data-bs-toggle="tooltip" title="Horizontal"
                            data-value="horizontal"><img src="{{url('')}}/assets/assets2/images/customizer/horizontal.svg" alt="img"
                                                         class="img-fluid"> </a><a href="#"
                                                                                   data-bs-toggle="tooltip"
                                                                                   title="Color Header"
                                                                                   data-value="color-header"><img
                                src="{{url('')}}/assets/assets2/images/customizer/color-header.svg" alt="img" class="img-fluid"> </a><a
                            href="#" data-bs-toggle="tooltip" title="Compact"
                            data-value="compact"><img src="{{url('')}}/assets/assets2/images/customizer/compact.svg" alt="img"
                                                      class="img-fluid"> </a><a href="#"
                                                                                data-bs-toggle="tooltip" title="Tab"
                                                                                data-value="tab"><img
                                src="{{url('')}}/assets/assets2/images/customizer/tab.svg" alt="img" class="img-fluid"></a></div>
                </li>
                        ...
                        <div class="col-6">
                            <div class="d-grid">
                                <button class="preset-btn btn-img btn active" data-value="true"
                                        ...
                                        title="Caption Show"><img src="{{url('')}}/assets/assets2/images/customizer/caption-on.svg"
                        ...
                        <div class="col-6">
                            <div class="d-grid">
                                <button class="preset-btn btn-img btn" data-value="false"
                                        ...
                                        title="Caption Hide"><img src="{{url('')}}/assets/assets2/images/customizer/caption-off.svg"
                                                                  alt="img" class="img-fluid"></button>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="col-6">
                                <div class="d-grid">
                                    <button class="preset-btn btn-img btn active" data-value="false"
                                        ...
                                        <img src="{{url('')}}/assets/assets2/images/customizer/ltr.svg" alt="img" class="img-fluid">
                                    </button>
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="d-grid">
                                    <button class="preset-btn btn-img btn" data-value="true"
                                        ...
                                        <img src="{{url('')}}/assets/assets2/images/customizer/rtl.svg" alt="img" class="img-fluid">
                                    </button>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-6">
                                <div class="d-grid">
                                    <button class="preset-btn btn-img btn active" data-value="false"
                                            ...
                                            title="Full Width"><img src="{{url('')}}/assets/assets2/images/customizer/full.svg" alt="img"
                            ...
                            <div class="col-6">
                                <div class="d-grid">
                                    <button class="preset-btn btn-img btn" data-value="true"
                                            ...
                                            title="Fixed Width"><img src="{{url('')}}/assets/assets2/images/customizer/fixed.svg"
                                                                     alt="img" class="img-fluid"></button>
                                </div>
                            </div>
                        </div>
