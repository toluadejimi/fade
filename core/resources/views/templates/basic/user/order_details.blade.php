                                            ...
                                            @forelse($orderItems as $item)
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <input type="text"
                                                               id="copy@php echo nl2br(@$item->productDetail->id) @endphp"
                                                               class="form-control text-small"
                                                               style="font-size: smaller; border: none"
                                                               value="@php echo nl2br(@$item->productDetail->details) @endphp">
                                                        <span
                                                            id="message@php echo nl2br(@$item->productDetail->id) @endphp"></span>


                                                        <script>

                                                            @php $id = $item->productDetail->id @endphp
                                                            var id = {{$id}};

                                                            function copyToClipboard{{$id}}() {
                                                                var textToCopy = document.getElementById("copy" + {{$id}});
                                                                var copyMessage = document.getElementById("message" + {{$id}});
                                                    ...
                                                    <td>
                                                        ...
                                                        <i onclick="copyToClipboard{{$id}}()" class="fa fa-copy"> </i>
