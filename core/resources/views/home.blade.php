...
<head>
    ...
    <!-- All CSS Stylesheet-->
    <link rel="stylesheet" href="{{url('')}}/assets/front/css/all-css-libraries.css">
    <!-- Core Stylesheet-->
...
<header class="header-area">
    <nav class="navbar navbar-expand-lg">
        <div class="container">
            <!-- Navbar Brand --><a class="navbar-brand" href="index.html"><img src="{{url('')}}/assets/assets2/images/logo-white.svg"></a>
            <!-- Navbar Toggler -->
    ...
    <div class="container h-100">
        <div class="row h-100 align-items-center justify-content-between">
            ...
            <div class="col-12 col-sm-9 col-md-6">
                <div class="welcome-thumb ms-xl-5 wow fadeInUp" data-wow-duration="1s" data-wow-delay="1s"><img src="{{url('')}}/assets/front/img/illustrator/hero-3.png" alt=""></div>
            </div>
        </div>
    </div>
</div>
...
<script src="{{url('')}}/assets/front/js/all-js-libraries.js"></script>
<script src="{{url('')}}/assets/front/js/active.js"></script>
</body>
</html>
