                ...
                <div class="dashboard-body__content">
                    <div class="dashboard-body__item-wrapper">
                        ...
                        <div class="p-3">
                            ...
                            <a style="background: #F95D3BFF; border: 0px"
                    ...
                    <table class="table style-two">
                        ...
                        <?php $__empty_1 = true; $__currentLoopData = $deposits; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $deposit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                ...
                                <td>
                                    <p><?php echo e(number_format($deposit->amount, 2)); ?></p>
                                </td>
                                <td>
                    ...
                    <div class="d-flex justify-content-start my-3">
                        ...
                        <nav aria-label="Page navigation example">
                            <ul class="pagination common-pagination mt-0">
                                <li class="page-item"> <?php echo e(paginateLinks($deposits)); ?></li>
...
<?php echo $__env->make($activeTemplate.'layouts.main2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/fade/core/resources/views/templates/basic/user/deposit_new.blade.php ENDPATH**/ ?>
