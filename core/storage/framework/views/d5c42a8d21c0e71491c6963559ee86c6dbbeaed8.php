...
<head><title>FADDED | LOGSTORE</title><!-- [Meta] -->
    ...
    <link rel="stylesheet" href="<?php echo e(url('')); ?>/assets/style2.css">
            ...
            <div class="navbar-content">
                <div class="card pc-user-card">
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="flex-grow-1 ms-3 me-2">
                                ...
                                <a href="/user/dashboard"><h6 class="mb-0"><?php echo e(Auth::user()->email); ?></h6></a>
                    ...
                    <ul class="pc-navbar">
                        ...
                        <li class="pc-item">
                            <a href="https://emonverify.com" class="pc-link">
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/fade/core/resources/views/templates/basic/layouts/main2.blade.php ENDPATH**/ ?>
