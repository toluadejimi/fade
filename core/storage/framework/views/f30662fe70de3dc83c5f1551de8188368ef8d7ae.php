            ...
            <div class="container">
                <div class="header-content">
                    <div class="left-content">
                        ...
                        <h5 class="mb-0 ms-2 text-nowrap">Not Found</h5>
                    </div>
    ...
    <div class="content-body">
        <div class="container">
            <div class="error-page">
                ...
                <div class="clearfix">
                    <h2 class="title text-primary">Session Expired</h2>
                    <p>Go back home and refresh your browser</p>
                </div>

                <a href="/" class="btn btn-dark btn-sm">Go Home</a>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/project/fadded/core/resources/views/errors/419.blade.php ENDPATH**/ ?>
