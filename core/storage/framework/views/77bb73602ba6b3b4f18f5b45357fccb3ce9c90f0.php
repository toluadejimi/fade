                    ...
                    <div class="text-center">
                        ...
                        <form method="POST" action="<?php echo e(route('user.login')); ?>" class="verify-gcaptcha">
                                    ...
                                    <div class="position-relative">
                                        <div class="mb-3">
                                            <input
                                                ...
                                                id="email" name="username" value="<?php echo e(old('username')); ?>"
                            ...
                            <div class="d-grid mt-4">
                                <button style="background: #F95D3B; border: 0px" type="submit" class="btn btn-primary">Login</button>
                            </div>
                        ...
                        <div class="d-flex justify-content-between align-items-end mt-4">
                            ...
                            <a style="color: #F95D3B;" href="/user/register" class="link-primary"
                            >Create Account</a
                            >
                        </div>
                    </div>
                ...
                <ul class="list-group list-group-flush">
                    ...
                    <li class="list-group-item">
                        ...
                        <div class="theme-main-layout d-flex align-center gap-1 w-100">
                            ...
                            ><img
                                    src="<?php echo e(url('')); ?>/assets/assets2/images/customizer/horizontal.svg"
                                    alt="img"
                                    class="img-fluid"
                                /> </a
                            ><a
                            ...
                            ><img
                                    src="<?php echo e(url('')); ?>/assets/assets2/images/customizer/color-header.svg"
                                    alt="img"
                                    class="img-fluid"
                                /> </a
                            ><a
                                ...
                                data-value="compact"
                            ><img
                                    src="<?php echo e(url('')); ?>/assets/assets2/images/customizer/compact.svg"
                                    alt="img"
                                    class="img-fluid"
                                /> </a
                            ><a
                                ...
                                data-value="tab"
                            ><img
                                    src="<?php echo e(url('')); ?>/assets/assets2/images/customizer/tab.svg"
                                    alt="img"
                                    class="img-fluid"
                                /></a>
                        </div>
                            ...
                            <div class="row theme-color theme-direction">
                                <div class="col-6">
                                    <div class="d-grid">
                                        ...
                                        >
                                            <img
                                                src="<?php echo e(url('')); ?>/assets/assets2/images/customizer/ltr.svg"
                                                alt="img"
                                                class="img-fluid"
                                            />
                                        </button>
                                ...
                                <div class="col-6">
                                    <div class="d-grid">
                                        ...
                                        >
                                            <img
                                                src="<?php echo e(url('')); ?>/assets/assets2/images/customizer/rtl.svg"
                                                alt="img"
                                                class="img-fluid"
                                            />
                                        </button>
                            ...
                            <div class="row theme-color theme-container">
                                <div class="col-6">
                                    <div class="d-grid">
                                        ...
                                        >
                                            <img
                                                src="<?php echo e(url('')); ?>/assets/assets2/images/customizer/full.svg"
                                                alt="img"
                                                class="img-fluid"
                                            />
                                        </button>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/fade/core/resources/views/templates/basic/user/auth/login.blade.php ENDPATH**/ ?>