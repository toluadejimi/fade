                ...
                <div class="row p-4">
                    ...
                    <div class="col-6">
                        <div class="card border-0  p-4">
                            ...
                            <strong class="text-center"><?php echo e(number_format(Auth::user()->click_count)); ?></strong>
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="card border-0  p-4">
                            <h6 class="text-center">Total Sign Up</h6>
                            <strong class="text-center"><?php echo e(number_format(Auth::user()->sign_up_count)); ?></strong>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make($activeTemplate.'layouts.main2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/project/fadded/core/resources/views/templates/basic/user/referal.blade.php ENDPATH**/ ?>