    ...
    <div class="sidebar__inner">
        ...
        <div class="sidebar__menu-wrapper" id="sidebar__menuWrapper">
            <ul class="sidebar__menu">
                ...
                <li class="sidebar-menu-item <?php echo e(menuActive('admin.category.all')); ?>">
                ...
                <li class="sidebar-menu-item <?php echo e(menuActive('admin.product*')); ?>">
                    <a href="<?php echo e(route('admin.product.all')); ?>" class="nav-link ">
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    ...
                    <div class="sidebar-submenu <?php echo e(menuActive('admin.report*',2)); ?> ">
                        <ul>
                            <li class="sidebar-menu-item <?php echo e(menuActive(['admin.report.order.history'])); ?>">
                ...
                <li class="sidebar-menu-item ">
                    <a href="<?php echo e(route('admin.coupon')); ?>" class="nav-link"
                       data-default-url="<?php echo e(route('admin.coupon')); ?>">
                        <i class="menu-icon las la-thumbs-up"></i>
                        <span class="menu-title"><?php echo app('translator')->get('Coupon'); ?> </span>
                    </a>
                </li>
...
<?php $__env->stopPush(); ?>
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/project/fadded/core/resources/views/admin/partials/sidenav.blade.php ENDPATH**/ ?>